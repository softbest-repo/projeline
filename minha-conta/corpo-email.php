	...
	<body>
		<div style='width:588px; min-height:500px; margin:0 auto; border:2px solid ".$cor1.";'>
			...
			<div style='width:588px;'>	
				<table>
					<tr>
						<td><h2 style='color:#000; margin:0; padding-top:15px; padding-bottom:10px;'>Cadastre-se</h2></td>
					</tr>
				</table>
				<table>
					<tr>
						<td style='color:#000000'>Obrigado <strong>".$nome."</strong>, por se cadastrar em nosso site!</td>
					</tr>
				</table>
				<table>
					<tr>
					...
					<tr>
						<td colspan='2'><strong>Nome:</strong> ".$nome.' '.$sobrenome."</td>
					</tr>
					<tr>
			...
			<div style='width:588px; border-top:15px solid ".$cor2."; border-bottom: 2px solid #000; margin-top:50px; height:85px;'>					
				<table style='float:left; width:480px; margin-top:10px;'>
					<tr>
						<td style='font-size:14px; color:#000000; padding-bottom:20px;'><strong>".$nomeEmpresa."</strong></td>
					</tr>				
					<tr>
	...
	<body>
		<div style='width:588px; min-height:500px; margin:0 auto; border:2px solid ".$cor1.";'>
			...
			<div style='width:588px;'>	
				...
				<table>
					<tr>
						<td style='color:#000000;'><strong>".$nome."</strong> esteve no site e se cadastrou!</td>
					</tr>
				</table>
				<table>
					<tr>

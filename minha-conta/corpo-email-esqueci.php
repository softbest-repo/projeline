	...
	<body>
		<div style='width:588px; min-height:500px; margin:0 auto; border:2px solid ".$cor1.";'>
			...
			<div style='width:588px;'>	
				...
				<table>
					<tr>
						<td style='color:#000000'>Olá <strong>".$nomeCliente.' '.$sobrenomeCliente."</strong>, sua senha foi recuperada com sucesso!</td>
					</tr>
				</table>
				<table>
					<tr>
					...
					<tr>
						<td colspan='2'><strong>Nome:</strong> ".$nomeCliente.' '.$sobrenomeCliente."</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan='2'><strong>Senha:</strong> ".$senhaCliente."</td>
					</tr>
				</table>
			</div>

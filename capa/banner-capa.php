...
?>
											<li class="imagem-banner"><img style="display:block;" src="<?php echo $configUrlGer . 'f/banners/' . $dadosImagem['codBanner'] . '-' . $dadosImagem['codBannerImagem'] . '-W.webp'; ?>" width="100%"/></li>
<?php
											}
										} else {
?>

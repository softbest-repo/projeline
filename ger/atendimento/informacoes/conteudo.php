...
?>						
						...
						<form action="<?php echo $configUrlGer; ?>atendimento/informacoes/" method="post">
							...
							<p class="bloco-campo"><label>Link de Rota: <span class="obrigatorio"> </span></label>

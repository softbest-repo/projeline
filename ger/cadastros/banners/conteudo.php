				...
				<div id="filtro">
					...
					<div class="demoTarget">
						<div id="formulario-filtro">
							...
							<form name="filtro" action="<?php echo $configUrl;?>cadastros/banners/" method="post" />
...
<?php
				if(isset($_POST['cadastrar'])){
					...
					$sql = "INSERT INTO banners VALUES(0, ".$novoOrdem.", '".preparaNome($_POST['nome'])."', '".$_POST['titulo']."', '".$_POST['frase']."', '".str_replace("\"", "&quot;", str_replace("'", "&#39;", $_POST['link']))."', '".$_POST['novaAba']."', 'T', '".$urlBanner."')";
					...
					if($result == 1){
						if(isset($_POST['cadastrar'])){
							...
							echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrlGer."cadastros/banners/'>";
						}else{
...
?>				
						...
						<br/>
						<form action="<?php echo $configUrlGer; ?>cadastros/banners/" method="post">
...
?>
								<tr class="tr">
									...
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>cadastros/banners/alterar/<?php echo $dadosBanner['codBanner'] ?>/' title='Veja os detalhes do banner capa <?php echo $dadosBanner['nomeBanner'] ?>'><?php echo $dadosBanner['nomeBanner'];?></a></td> 
									<td class="botoes" style="width:5%;"><a style="padding:0px;" href='<?php echo $configUrl; ?>cadastros/banners/imagens/<?php echo $dadosBanner['codBanner'] ?>/' title='Deseja gerenciar imagens do banner <?php echo $dadosBanner['nomeBanner'] ?>?' ><img style="<?php echo $dadosImagem['codBannerImagem'] == "" ? 'display:none;' : 'padding-top:18px;';?>" src="<?php echo $configUrlGer.'f/banners/'.$dadosImagem['codBanner'].'-'.$dadosImagem['codBannerImagem'].'-W.webp';?>" height="30"/><img style="<?php echo $dadosImagem['codBannerImagem'] != "" ? 'display:none;' : '';?>" src="<?php echo $configUrl; ?>f/i/default/corpo-default/gerenciar-imagens.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>cadastros/banners/ativacao/<?php echo $dadosBanner['codBanner'] ?>/' title='Deseja <?php echo $statusPergunta ?> o banner capa <?php echo $dadosBanner['nomeBanner'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>cadastros/banners/alterar/<?php echo $dadosBanner['codBanner'] ?>/' title='Deseja alterar o banner capa <?php echo $dadosBanner['nomeBanner'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
							...
							new Sortable(dragArea, {
								...
								onEnd: function(e) {
									...
									for (i = 0; i < myLength; i++) {
										cont++;
										$tgb.post("<?php echo $configUrlGer;?>cadastros/banners/ordena.php", {codBanner: allinputs[i].value, codOrdenacaoBanner: cont});
									}
								}
							});						
						</script>

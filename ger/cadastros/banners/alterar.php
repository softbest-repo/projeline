...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/banners/ativacao/<?php echo $dadosNomePagamento['codBanner'] ?>/' title='Deseja <?php echo $statusPergunta ?> o banner capa <?php echo $dadosNomePagamento['nomeBanner'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
...
<?php
				if(isset($_POST['alterar'])){
					...
					$sql = "UPDATE banners SET nomeBanner = '".preparaNome($_POST['nome'])."', tituloBanner = '".$_POST['titulo']."', fraseBanner = '".$_POST['frase']."', linkBanner = '".str_replace("\"", "&quot;", str_replace("'", "&#39;", $_POST['link']))."', novaAbaBanner = '".$_POST['novaAba']."', urlBanner = '".$urlBanner."' WHERE codBanner = '".$url[6]."'";
					...
					$_SESSION['frase'] = $dadosBanner['fraseBanner'];
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>cadastros/banners/alterar/<?php echo $url[6] ;?>/" method="post">

...
?>
				<div id="localizacao-topo">
					<div id="conteudo-localizacao-topo">
						...
						<p class="flexa"></p>
						<p class="nome-lista">Características de Comparativos</p>
						<p class="flexa"></p>
...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/caracteristicas/ativacao/<?php echo $dadosNomePagamento['codCaracteristica'] ?>/' title='Deseja <?php echo $statusPergunta ?> a característica <?php echo $dadosNomePagamento['nomeCaracteristica'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>cadastros/caracteristicas/alterar/<?php echo $url[6] ;?>/" method="post">

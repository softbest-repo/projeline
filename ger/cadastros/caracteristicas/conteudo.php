...
<?php
					...
					while($dadosCaracteristica = $resultCaracteristica->fetch_assoc()){
						...
						$sqlImagem =  "SELECT * FROM caracteristicasImagens WHERE  codCaracteristica = '".$dadosCaracteristica['codCaracteristica']."'";
...
?>
								...
								<tr class="tr">
									...
									<td class="botoes" style="width:5%;"><a style="padding:0px;" href='<?php echo $configUrl;?>cadastros/caracteristicas/imagens/<?php echo $dadosCaracteristica['codCaracteristica'] ?>/' title='Deseja gerenciar imagens <?php echo $dadosCaracteristica['nomeCaracteristica'] ?>?' ><img style="<?php echo $dadosImagem['codCaracteristicaImagem'] == "" ? 'display:none;' : 'padding-top:10px;';?>" src="<?php echo $configUrlGer.'f/caracteristicas/'.$dadosImagem['codCaracteristica'].'-'.$dadosImagem['codCaracteristicaImagem'].'-O.'.$dadosImagem['extCaracteristicaImagem'];?>" height="45"/><img style="<?php echo $dadosImagem['codCaracteristicaImagem'] != "" ? 'display:none;' : '';?>" src="<?php echo $configUrl; ?>f/i/default/corpo-default/gerenciar-imagens.gif" alt="icone"></a></td>

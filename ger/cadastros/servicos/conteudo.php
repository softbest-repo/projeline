...
?>
								<tr class="tr">
									...
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>cadastros/servicos/alterar/<?php echo $dadosServico['codServico'] ?>/' title='Veja os detalhes da área de atuação <?php echo $dadosServico['nomeServico'] ?>'><?php echo $dadosServico['nomeServico'];?></a></td> 
									<td class="botoes" style="width:5%;"><a style="padding:0px;" href='<?php echo $configUrl; ?>cadastros/servicos/imagens/<?php echo $dadosServico['codServico'] ?>/' title='Deseja gerenciar imagens do banner <?php echo $dadosServico['nomeServico'] ?>?' ><img style="<?php echo $dadosImagem['codServicoImagem'] == "" ? 'display:none;' : 'padding-top:10px;';?>" src="<?php echo $configUrlGer.'f/servicos/'.$dadosImagem['codServico'].'-'.$dadosImagem['codServicoImagem'].'-O.'.$dadosImagem['extServicoImagem'];?>" height="45"/><img style="<?php echo $dadosImagem['codServicoImagem'] != "" ? 'display:none;' : '';?>" src="<?php echo $configUrl; ?>f/i/default/corpo-default/gerenciar-imagens.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>cadastros/servicos/ativacao/<?php echo $dadosServico['codServico'] ?>/' title='Deseja <?php echo $statusPergunta ?> a área de atuação <?php echo $dadosServico['nomeServico'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>cadastros/servicos/alterar/<?php echo $dadosServico['codServico'] ?>/' title='Deseja alterar a área de atuação <?php echo $dadosServico['nomeServico'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
							...
							new Sortable(dragArea, {
								...
								onEnd: function(e) {
									...
									for (i = 0; i < myLength; i++) {
										cont++;
										$tgb.post("<?php echo $configUrlGer;?>cadastros/servicos/ordena.php", {codServico: allinputs[i].value, codOrdenacaoServico: cont});
									}
								}
							});				
						</script>	

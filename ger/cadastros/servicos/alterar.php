...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/servicos/ativacao/<?php echo $dadosNomePagamento['codServico'] ?>/' title='Deseja <?php echo $statusPergunta ?> a área de atuação <?php echo $dadosNomePagamento['nomeServico'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>cadastros/servicos/alterar/<?php echo $url[6] ;?>/" method="post">

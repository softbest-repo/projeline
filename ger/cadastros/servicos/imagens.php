...
?>	
						<tr class="tr-interno">
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/servicos/ativacao/<?php echo $dadosNomeServico['codServico'] ?>/' title='Deseja <?php echo $statusPergunta ?> a área de atuação <?php echo $dadosNomeServico['nomeServico'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>-branco.gif" alt="icone"></a></td>
							<td class="botoes-interno"><a href='<?php echo $configUrl; ?>cadastros/servicos/alterar/<?php echo $dadosNomeServico['codServico'] ?>/' title='Deseja alterar a área de atuação <?php echo $dadosNomeServico['nomeServico'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar-branco.gif" alt="icone" /></a></td>
					...
					<div class="botao-consultar"><a title="Consultar Áreas de Atuação" href="<?php echo $configUrl;?>cadastros/servicos/"><div class="esquerda-consultar"></div><div class="conteudo-consultar">Consultar</div><div class="direita-consultar"></div></a></div>					
				</div>
...
?>				
						...
						<form action="<?php echo $configUrlGer; ?>cadastros/servicos/imagens/<?php echo $url[6];?>/" enctype="multipart/form-data" method="post">
...
?>
 ...
 <?php
				...
				$regPorPag = 14;
				$area = "cadastros/servicos/imagens/".$url[6];

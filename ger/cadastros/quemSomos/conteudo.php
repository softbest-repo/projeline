		...
		if($controleUsuario == "tem usuario"){
			...
			if($validaAcesso == "ok"){
				...
				if($_SESSION['alteracao'] == "ok"){
					$erroConteudo = "<p class='erro'><strong>".$_SESSION['nome']."</strong> alterado com sucesso!</p>";
					$_SESSION['alteracao'] = "";
					$_SESSION['nome'] = "";
					$_SESSION['descricao'] = "";
				}		
...
?>
								<tr class="tr">
									<td class="noventa"><a href='<?php echo $configUrlGer; ?>cadastros/quemSomos/alterar/<?php echo $dadosQuemSomos['codQuemSomos'] ?>/' title='Veja os detalhes <?php echo $dadosQuemSomos['nomeQuemSomos'] ?>'><?php echo strip_tags($dadosQuemSomos['nomeQuemSomos']);?></a></td>  
									<td class="botoes" style="width:5%;"><a style="padding:0px;" href='<?php echo $configUrl; ?>cadastros/quemSomos/imagens/<?php echo $dadosQuemSomos['codQuemSomos'] ?>/' title='Deseja gerenciar imagens <?php echo $dadosQuemSomos['nomeQuemSomos'] ?>?' ><img style="<?php echo $dadosImagem['codQuemSomosImagem'] == "" ? 'display:none;' : 'padding-top:5px;';?>" src="<?php echo $configUrlGer.'f/quemSomos/'.$dadosImagem['codQuemSomos'].'-'.$dadosImagem['codQuemSomosImagem'].'-W.webp';?>" height="50"/><img style="<?php echo $dadosImagem['codQuemSomosImagem'] != "" ? 'display:none;' : '';?>" src="<?php echo $configUrl; ?>f/i/default/corpo-default/gerenciar-imagens.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>cadastros/quemSomos/alterar/<?php echo $dadosQuemSomos['codQuemSomos'] ?>/' title='Deseja alterar <?php echo $dadosQuemSomos['nomeQuemSomos'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
								</tr>
<?php							
					}
?>							 

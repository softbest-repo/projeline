...
<?php
				if(isset($_POST['alterar'])){
					...
					if($result == 1){
						...
						echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=".$configUrlGer."cadastros/quemSomos/'>";
					}else{
						$erroData = "<p class='erro'>Problemas o alterar o quem somos!</p>";
					}
				}else{
...
?>
						...
						<form action="<?php echo $configUrlGer; ?>cadastros/quemSomos/alterar/<?php echo $url[6] ;?>/" method="post">

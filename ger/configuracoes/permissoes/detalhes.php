...
?>								
						...
						<div id="permissoes-atendimento" style=" ">
								<p class="area-permicao">Projeto(s):</p>
<?php			
...
?>								
							...
							<div id="permissoes-atendimento">
								<p class="area-permicao">Atendimento:</p>
<?php
				$sqlAreasRelatorios = "SELECT * FROM areasAcesso WHERE codMenuAreaAcesso = 5 and statusAreaAcesso = 'T' ORDER BY codAreaAcesso ASC";
				$resultAreasRelatorios = $conn->query($sqlAreasRelatorios);
				while($dadosAreasRelatorios = $resultAreasRelatorios->fetch_assoc()){
...
<?php
				$sqlAreasRelatorios = "SELECT * FROM areasAcesso WHERE codMenuAreaAcesso = 4 and statusAreaAcesso = 'T' ORDER BY codAreaAcesso ASC";
				$resultAreasRelatorios = $conn->query($sqlAreasRelatorios);
				while($dadosAreasRelatorios = $resultAreasRelatorios->fetch_assoc()){

					...
					if($registrosNome == 0){		
						...
						if($registros == 0){
							if($_POST['senha'] == $_POST['confirma-senha']){
								...
								$sql = "UPDATE usuarios SET nomeUsuario = '".preparaNome($_POST['nome'])."', dataCadastro = '".$_POST['dataCadastro']."', sobrenomeUsuario = '".preparaNome($_POST['sobrenome'])."', ruaUsuario = '".$_POST['rua']."', numeroUsuario = '".$_POST['numero']."', bairroUsuario = '".$_POST['bairro']."', codCidade = '".$_POST['cidade']."', codEstado = '".$_POST['estado']."', telefoneUsuario = '".$_POST['telefone']."', celularUsuario = '".$_POST['celular']."', emailUsuario = '".$_POST['email']."', cpfUsuario = '".$_POST['cpf']."', rgUsuario = '".$_POST['rg']."', sexoUsuario = '".$_POST['sexo']."', usuarioUsuario = '".$_POST['usuario']."', senhaUsuario = '".base64_encode($_POST['senha'])."' WHERE codUsuario = '".$url[6]."'";
...
?>				
						...
						<form name="formUsuarioes" action="<?php echo $configUrlGer; ?>configuracoes/usuarios/alterar/<?php echo $url[6] ;?>/" method="post">
							...
							<input id="nome" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="nome" style="width:330px;" required value="<?php echo $_SESSION['nome']; ?>" /></p>
						
							<p class="bloco-campo-float"><label>Sobrenome: <span class="obrigatorio"> * </span></label>
							<input id="sobrenome" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="text" name="sobrenome" style="width:410px;" required value="<?php echo $_SESSION['sobrenome']; ?>" /></p>
...
?>
							...
							<input id="email" <?php echo $erroAtiva == "ok" ? "" : "disabled='disabled'";?> class="campo" type="email" name="email" style="width:300px;" value="<?php echo $_SESSION['email']; ?>"/></p>

				...
				<div id="filtro">
					...
					<div class="demoTarget">
						...
						<div id="formulario-filtro">
							<form action="<?php echo $configUrl;?>configuracoes/usuarios/" method="post" >							
						...
						if($registrosTotal < $configLimite){
							...
							if($registrosNome == 0){
								...
								if($registros == 0){ 
									...
									$sql = "INSERT INTO usuarios VALUES(0, 1, '".$_POST['nome']."', '".date("Y-m-d")."', '".$_POST['sobrenome']."', 'A', '".$_POST['rua']."', '".$_POST['numero']."', '".$_POST['bairro']."', '".$_POST['cidade']."', '".$_POST['estado']."', '".$_POST['telefone']."', '".$_POST['celular']."', '".$_POST['email']."', '".$_POST['cpfCol']."', '".$_POST['rg']."', '".$_POST['sexo']."', '".$_POST['usuario']."', '".base64_encode($_POST['senha'])."', 'T')";
...
?>				
						...
						<br/>
						<form name="formUsuarioes" action="<?php echo $configUrlGer; ?>configuracoes/usuarios/" method="post" onSubmit="return valida_dados2(this)">
							...
							<input class="campo" type="text" id="sobrenome" name="sobrenome" style="width:410px;" required value="<?php echo $_SESSION['sobrenome']; ?>" /></p>
							...
							<input class="campo" type="text" id="bairro" name="bairro" style="width:140px;" value="<?php echo $_SESSION['bairro']; ?>"/></p>
...
?>					
							...
							<input class="campo" type="text" id="cpfCol" name="cpfCol" style="width:110px;" value="<?php echo $_SESSION['cpfCol']; ?>" onKeyDown="Mascara(this,Cpf);" onKeyPress="Mascara(this,Cpf);" onKeyUp="Mascara(this,Cpf)" /></p>

							<p class="bloco-campo-float"><label>RG:</label>
							<input class="campo" type="text" id="rg" name="rg" style="width:110px;" value="<?php echo $_SESSION['rg']; ?>"/></p>
							...
							<input class="campo" type="text" id="celular" name="celular" style="width:100px;" value="<?php echo $_SESSION['celular']; ?>"   onKeyDown="Mascara(this,novoTelefone);" onKeyPress="Mascara(this,novoTelefone);" onKeyUp="Mascara(this,novoTelefone)"/></p>
							...
							<input class="campo" type="email" id="email" name="email" style="width:300px;" value="<?php echo $_SESSION['email']; ?>"/></p>
...
<?php
					if($url[3] != ""){
						if($url[5] == 1 || $url[5] == ""){
							$pagina = 1;
							$sqlUsuarioes = "SELECT E.codFilial, E.nomeFilial, Co.nomeUsuario, Co.codUsuario, Co.statusUsuario, Co.codFilial FROM filiais E inner join usuarios Co on Co.codFilial = E.codFilial WHERE Co.codUsuario != 4".$filtraUsuario." ORDER BY Co.statusUsuario ASC, Co.nomeUsuario ASC, E.nomeFilial ASC, Co.codEstado ASC, Co.codCidade ASC LIMIT 0,30";
						}else{
							$pagina = $url[4];
							$paginaFinal = $pagina * 30;
							$paginaInicial = $paginaFinal - 30;
							$sqlUsuarioes = "SELECT E.codFilial, E.nomeFilial, Co.nomeUsuario, Co.codUsuario, Co.statusUsuario, Co.codFilial FROM filiais E inner join usuarios Co on Co.codFilial = E.codFilial WHERE Co.codUsuario != 4".$filtraUsuario." ORDER BY Co.statusUsuario ASC, Co.nomeUsuario ASC, E.nomeFilial ASC, Co.codEstado ASC, Co.codCidade ASC LIMIT ".$paginaInicial.",30";
						}		
					}
...
?>
								...
								<tr class="tr">
									<td class="oitenta"><a href='<?php echo $configUrlGer; ?>configuracoes/usuarios/alterar/<?php echo $dadosUsuarioes['codUsuario'] ?>/' title='Veja os detalhes do usuário <?php echo $dadosUsuarioes['nomeUsuario'] ?>'><?php echo $dadosUsuarioes['nomeUsuario'];?></a></td>
									...
									<td class="botoes"><a href='<?php echo $configUrl; ?>configuracoes/usuarios/ativacao/<?php echo $dadosUsuarioes['codUsuario'] ?>/' title='Deseja <?php echo $statusPergunta ?> o usuário <?php echo $dadosUsuarioes['nomeUsuario'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
									<td class="botoes"><a href='<?php echo $configUrl; ?>configuracoes/usuarios/alterar/<?php echo $dadosUsuarioes['codUsuario'] ?>/' title='Deseja alterar o usuário <?php echo $dadosUsuarioes['nomeUsuario'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>

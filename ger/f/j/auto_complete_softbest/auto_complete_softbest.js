		...
		if(value != ""){
			if(e.which != 40 && e.which != 38 && e.which != 37 && e.which != 39 && e.which != 13){
				...
				buscaAuto = setTimeout(function(){
					$tr.post("http://192.168.0.200/dapraia/ger/auto_complete_softbest_"+arquivo+".php", {value: value}, function(data){	
	...
	function novoItem(value, arquivo){
		...
		if(value != ""){
			$ni.post("http://192.168.0.200/dapraia/ger/novo_item_"+arquivo+".php", {value: value}, function(data){										

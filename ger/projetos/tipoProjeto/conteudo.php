...
?>
				...
				<div id="filtro">
					...
					<div id="formulario-filtro">
						...
						<form name="filtro" action="<?php echo $configUrl;?>projetos/tipoProjeto/" method="post" />
...
<?php
				if(isset($_POST['cadastrar'])){
					...
					$sql = "INSERT INTO tipoProjeto VALUES(0, '".$_POST['nome']."', '".$_POST['sigla']."', 'T', '".$urlTipoProjeto."')";
...
?>				
						...
						<br/>
						<form action="<?php echo $configUrlGer; ?>projetos/tipoProjeto/" method="post">
...
<?php
				...
				$sqlConta = "SELECT * FROM tipoProjeto WHERE codTipoProjeto != ''";
				$resultConta = $conn->query($sqlConta);
				$dadosConta = $resultConta->fetch_assoc();
				$registros = mysqli_num_rows($resultConta);

				if($dadosConta['nomeTipoProjeto'] != ""){
?>
...
<?php
					...
					if($url[5] == 1 || $url[5] == ""){
						$pagina = 1;
						$sqlTipoProjeto = "SELECT * FROM tipoProjeto ORDER BY statusTipoProjeto ASC LIMIT 0,30";
					}else{
						$pagina = $url[5];
						$paginaFinal = $pagina * 30;
						$paginaInicial = $paginaFinal - 30;
						$sqlTipoProjeto = "SELECT * FROM tipoProjeto ORDER BY statusTipoProjeto ASC LIMIT ".$paginaInicial.",30";
					}		
					...
					while($dadosTipoProjeto = $resultTipoProjeto->fetch_assoc()){
						...
						if($dadosTipoProjeto['statusTipoProjeto'] == "T"){
							$status = "status-ativo";
							$statusIcone = "ativado";
...
?>
							...
							<tr class="tr">
								<td class="oitenta"><a href='<?php echo $configUrlGer; ?>projetos/tipoProjeto/alterar/<?php echo $dadosTipoProjeto['codTipoProjeto'] ?>/' title='Veja os detalhes do tipo imóvel <?php echo $dadosTipoProjeto['nomeTipoProjeto'] ?>'><?php echo $dadosTipoProjeto['nomeTipoProjeto'];?></a></td>
								<td class="dez" style="text-align:center;"><a href='<?php echo $configUrlGer; ?>projetos/tipoProjeto/alterar/<?php echo $dadosTipoProjeto['codTipoProjeto'] ?>/' title='Veja os detalhes do tipo imóvel <?php echo $dadosTipoProjeto['nomeTipoProjeto'] ?>'><?php echo $dadosTipoProjeto['siglaTipoProjeto'];?></a></td>
								<td class="botoes"><a href='<?php echo $configUrl; ?>projetos/tipoProjeto/ativacao/<?php echo $dadosTipoProjeto['codTipoProjeto'] ?>/' title='Deseja <?php echo $statusPergunta ?> o tipo imóvel <?php echo $dadosTipoProjeto['nomeTipoProjeto'] ?>?' ><img src="<?php echo $configUrl; ?>f/i/default/corpo-default/<?php echo $status ?>.gif" alt="icone"></a></td>
								<td class="botoes"><a href='<?php echo $configUrl; ?>projetos/tipoProjeto/alterar/<?php echo $dadosTipoProjeto['codTipoProjeto'] ?>/' title='Deseja alterar o tipo imóvel <?php echo $dadosTipoProjeto['nomeTipoProjeto'] ?>?' ><img src="<?php echo $configUrl;?>f/i/default/corpo-default/icones-alterar.gif" alt="icone" /></a></td>
								<td class="botoes"><a href='javascript: confirmaExclusao(<?php echo $dadosTipoProjeto['codTipoProjeto'] ?>, "<?php echo htmlspecialchars($dadosTipoProjeto['nomeTipoProjeto']) ?>");' title='Deseja excluir o tipo imóvel <?php echo $dadosTipoProjeto['nomeTipoProjeto'] ?>?' ><img src='<?php echo $configUrl; ?>f/i/default/corpo-default/excluir.gif' alt="icone"></a></td>
							</tr>
<?php
					}
?>
